...
public class HD_Account {
    ...
    public HD_Account(NetworkParameters params, DeterministicKey mKey, String label, int child) {
        ...
        strXPUB = aKey.serializePubB58(MasanariWallet.getInstance().getCurrentNetworkParams());
        strYPUB = aKey.serializePubB58(MasanariWallet.getInstance().getCurrentNetworkParams(), 49);
        strZPUB = aKey.serializePubB58(MasanariWallet.getInstance().getCurrentNetworkParams(), 84);
