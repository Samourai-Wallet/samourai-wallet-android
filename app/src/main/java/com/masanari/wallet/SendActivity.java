...
import com.masanari.wallet.send.SendParams;
...
import com.masanari.wallet.util.SendAddressUtil;
...
public class SendActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(MasanariWallet.getInstance().getShowTotalBalance())    {
            if(MasanariWallet.getInstance().getCurrentSelectedAccount() == 2)    {
                selectedAccount = 1;
            }
            else    {
                selectedAccount = 0;
...
//                Log.i("SendActivity", "amount:" + amount);
                ...
                if((FormatsUtil.getInstance().isValidBech32(address) || Address.fromBase58(MasanariWallet.getInstance().getCurrentNetworkParams(), address).isP2SHAddress()) || PrefsUtil.getInstance(SendActivity.this).getValue(PrefsUtil.USE_LIKE_TYPED_CHANGE, true) == false)    {
...
//                    Log.d("SendActivity", "p2pkh:" + neededAmount);
                ...
                neededAmount += amount;
                neededAmount += MasanariWallet.bDust.longValue();
...
//                    Log.d("SendActivity", "segwit utxos:" + utxos.size());
                ...
                else if(!FormatsUtil.getInstance().isValidBech32(address) && Address.fromBase58(MasanariWallet.getInstance().getCurrentNetworkParams(), address).isP2SHAddress() && (UTXOFactory.getInstance().getP2SH_P2WPKH().size() > 0 && UTXOFactory.getInstance().getTotalP2SH_P2WPKH() > neededAmount))    {
                    utxos = new ArrayList<UTXO>(UTXOFactory.getInstance().getP2SH_P2WPKH().values());
//                    Log.d("SendActivity", "segwit utxos:" + utxos.size());
                }
                else if((!FormatsUtil.getInstance().isValidBech32(address) && !Address.fromBase58(MasanariWallet.getInstance().getCurrentNetworkParams(), address).isP2SHAddress()) && (UTXOFactory.getInstance().getP2PKH().size() > 0) && (UTXOFactory.getInstance().getTotalP2PKH() > neededAmount))   {
...
//                    Log.d("SendActivity", "total value selected:" + totalValueSelected);
                ...
                if(SPEND_TYPE == SPEND_RICOCHET)    {
                    ...
                    boolean masanariFeeViaBIP47 = false;
                    if(BIP47Meta.getInstance().getOutgoingStatus(BIP47Meta.strMasanariDonationPCode) == BIP47Meta.STATUS_SENT_CFM)    {
                        masanariFeeViaBIP47 = true;
                    }

                    final JSONObject jObj = RicochetMeta.getInstance(SendActivity.this).script(amount, FeeUtil.getInstance().getSuggestedFee().getDefaultPerKB().longValue(), address, 4, strPCode, masanariFeeViaBIP47);
                    if(jObj != null)    {
                    ...
                    else if(!FormatsUtil.getInstance().isValidBech32(address) && (valueP2SH_P2WPKH > (neededAmount * 2)) && Address.fromBase58(MasanariWallet.getInstance().getCurrentNetworkParams(), address).isP2SHAddress())   {
                        Log.d("SendActivity", "set 1 P2SH_P2WPKH 2x");
                        _utxos1 = utxosP2SH_P2WPKH;
                        selectedP2SH_P2WPKH = true;
                    }
                    else if(!FormatsUtil.getInstance().isValidBech32(address) && (valueP2PKH > (neededAmount * 2)) && !Address.fromBase58(MasanariWallet.getInstance().getCurrentNetworkParams(), address).isP2SHAddress())   {
                ...
                // simple spend (less than balance)
                    ...
                    for(UTXO u : _utxos)   {
                        ...
                        if(u.getValue() >= (amount + MasanariWallet.bDust.longValue() + FeeUtil.getInstance().estimatedFeeSegwit(outpointTypes.getLeft(), outpointTypes.getMiddle(), outpointTypes.getRight(), 2).longValue()))    {
                            selectedUTXO.add(u);
                            totalValueSelected += u.getValue();
...
//                            Log.d("SendActivity", "value selected:" + u.getValue());
//                            Log.d("SendActivity", "total value selected/threshold:" + totalValueSelected + "/" + (amount + MasanariWallet.bDust.longValue() + FeeUtil.getInstance().estimatedFee(selected, 2).longValue()));
                            ...
                            if(totalValueSelected >= (amount + MasanariWallet.bDust.longValue() + FeeUtil.getInstance().estimatedFeeSegwit(p2pkh, p2sh_p2wpkh, p2wpkh, 2).longValue()))    {
//                                Log.d("SendActivity", "spend type:" + SPEND_TYPE);
...
//                                Log.d("SendActivity", "nb inputs:" + selected);
                    ...
                    for(TransactionOutput output : pair.getRight())   {
                        try {
                            ...
                            receivers.put(script.getToAddress(MasanariWallet.getInstance().getCurrentNetworkParams()).toString(), BigInteger.valueOf(output.getValue().longValue()));
...
//                    Log.d("SendActivity", "change:" + change);
                    ...
                    if(change > 0L && change < MasanariWallet.bDust.longValue() && SPEND_TYPE == SPEND_SIMPLE)    {
                            ...
                            if(PrefsUtil.getInstance(SendActivity.this).getValue(PrefsUtil.RBF_OPT_IN, false) == true)    {
                                ...
                                for(TransactionInput input : tx.getInputs())    {
                                    ...
                                    if(Bech32Util.getInstance().isBech32Script(script))    {
                                        ...
                                        Address _address = input.getConnectedOutput().getAddressFromP2SH(MasanariWallet.getInstance().getCurrentNetworkParams());
                                        if(_address != null)    {
                                    ...
                                    if(_addr == null)    {
                                        _addr = input.getConnectedOutput().getAddressFromP2PKHScript(MasanariWallet.getInstance().getCurrentNetworkParams()).toString();
                                    }
                                    ...
                                    public void run() {
                                        ...
                                        try {
                                            if(PrefsUtil.getInstance(SendActivity.this).getValue(PrefsUtil.USE_TRUSTED_NODE, false) == true)    {
                                                ...
                                                response = PushTx.getInstance(SendActivity.this).masanari(hexTx);
                                                ...
                                                if(PrefsUtil.getInstance(SendActivity.this).getValue(PrefsUtil.RBF_OPT_IN, false) == true)    {
                                                    ...
                                                    for(TransactionOutput out : _tx.getOutputs())   {
                                                        try {
                                                            ...
                                                            else if(changeType == 44 && !address.equals(out.getAddressFromP2PKHScript(MasanariWallet.getInstance().getCurrentNetworkParams()).toString()))  {
                                                                rbf.addChangeAddr(out.getAddressFromP2PKHScript(MasanariWallet.getInstance().getCurrentNetworkParams()).toString());
                                                                Log.d("SendActivity", "added change output:" + out.getAddressFromP2PKHScript(MasanariWallet.getInstance().getCurrentNetworkParams()).toString());
                                                            }
                                                            else if(changeType != 44 && !address.equals(out.getAddressFromP2SH(MasanariWallet.getInstance().getCurrentNetworkParams()).toString()))   {
                                                                rbf.addChangeAddr(out.getAddressFromP2SH(MasanariWallet.getInstance().getCurrentNetworkParams()).toString());
                                                                Log.d("SendActivity", "added change output:" + out.getAddressFromP2SH(MasanariWallet.getInstance().getCurrentNetworkParams()).toString());
                                                            }
                                                            else    {
                                                                ;
                                                            }
...
//                                        dialog.dismiss();
    ...
    private void doSupport()	{
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://support.masanari.io/section/8-sending-bitcoin"));
        startActivity(intent);
    }
            ...
            if(BIP47Meta.getInstance().getOutgoingStatus(pcode) == BIP47Meta.STATUS_SENT_CFM)    {
                try {
                    ...
                    if(BIP47Meta.getInstance().getSegwit(pcode))    {
                        SegwitAddress segwitAddress = new SegwitAddress(paymentAddress.getSendECKey(), MasanariWallet.getInstance().getCurrentNetworkParams());
                        strDestinationBTCAddress = segwitAddress.getBech32AsString();
                    }
                    else    {
                        strDestinationBTCAddress = paymentAddress.getSendECKey().toAddress(MasanariWallet.getInstance().getCurrentNetworkParams()).toString();
                    }
