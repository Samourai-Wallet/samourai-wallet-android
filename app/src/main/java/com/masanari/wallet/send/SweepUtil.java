            ...
            public void run() {
                ...
                try {
                    ...
                    if(type == TYPE_P2SH_P2WPKH)    {
                        ...
                        addressP2PKH = privKeyReader.getKey().toAddress(MasanariWallet.getInstance().getCurrentNetworkParams()).toString();
                        Log.d("SweepUtil", "address derived P2PKH:" + addressP2PKH);
                        addressP2SH_P2WPKH = new SegwitAddress(privKeyReader.getKey(), MasanariWallet.getInstance().getCurrentNetworkParams()).getAddressAsString();
                        Log.d("SweepUtil", "address derived P2SH_P2WPKH:" + addressP2SH_P2WPKH);
                        addressP2WPKH = new SegwitAddress(privKeyReader.getKey(), MasanariWallet.getInstance().getCurrentNetworkParams()).getBech32AsString();
