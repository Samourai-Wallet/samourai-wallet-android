...
import com.masanari.wallet.BuildConfig;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    String res = com.masanari.wallet.bip47.paynym.WebUtil.getInstance(BIP47ShowQR.this).postURL("application/json", null, com.masanari.wallet.bip47.paynym.WebUtil.PAYNYM_API + "api/v1/nym", obj.toString());
                        ...
                        if(array.getJSONObject(0).has("claimed") && array.getJSONObject(0).getBoolean("claimed") == true)    {
                            ...
                            handler.post(new Runnable() {
                                public void run() {
                                    ...
                                    Picasso.with(BIP47ShowQR.this).load(com.masanari.wallet.bip47.paynym.WebUtil.PAYNYM_API + strPaymentCode + "/avatar").into(ivAvatar);
