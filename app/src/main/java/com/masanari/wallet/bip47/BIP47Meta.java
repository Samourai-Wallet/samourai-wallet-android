...
public class BIP47Meta {
    ...
    public static final String strMasanariDonationPCode = "PM8TJVzLGqWR3dtxZYaTWn3xJUop3QP3itR4eYzX7XvV5uAfctEEuHhKNo3zCcqfAbneMhyfKkCthGv5werVbwLruhZyYNTxqbCrZkNNd2pPJA2e2iAh";
    public static final String strMasanariDonationMeta = "?title=Masanari Donations&desc=Donate to help fund development of Masanari Bitcoin Wallet&user=K6tS2X8";
