...
import com.masanari.wallet.util.BatchSendUtil;
...
import com.masanari.wallet.widgets.TransactionProgressView;
                        ...
                        public void run() {
                            ...
                            new Thread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    boolean isOK = false;
                                    String response = PushTx.getInstance(TxAnimUIActivity.this).masanari(hexTx);
                                    try {
                ...
                public void run() {
                    ...
                    try {
                        if (PrefsUtil.getInstance(TxAnimUIActivity.this).getValue(PrefsUtil.USE_TRUSTED_NODE, false) == true) {
                            ...
                            response = PushTx.getInstance(TxAnimUIActivity.this).masanari(hexTx);
                    ...
                    for (TransactionOutput out : _tx.getOutputs()) {
                        try {
                            if (Bech32Util.getInstance().isBech32Script(Hex.toHexString(out.getScriptBytes())) && !SendParams.getInstance().getDestAddress().equals(Bech32Util.getInstance().getAddressFromScript(Hex.toHexString(out.getScriptBytes())))) {
                                rbf.addChangeAddr(Bech32Util.getInstance().getAddressFromScript(Hex.toHexString(out.getScriptBytes())));
                                Log.d("SendActivity", "added change output:" + Bech32Util.getInstance().getAddressFromScript(Hex.toHexString(out.getScriptBytes())));
                            } else if (SendParams.getInstance().getChangeType() == 44 && !SendParams.getInstance().getDestAddress().equals(out.getAddressFromP2PKHScript(MasanariWallet.getInstance().getCurrentNetworkParams()).toString())) {
                                rbf.addChangeAddr(out.getAddressFromP2PKHScript(MasanariWallet.getInstance().getCurrentNetworkParams()).toString());
                                Log.d("SendActivity", "added change output:" + out.getAddressFromP2PKHScript(MasanariWallet.getInstance().getCurrentNetworkParams()).toString());
                            } else if (SendParams.getInstance().getChangeType() != 44 && !SendParams.getInstance().getDestAddress().equals(out.getAddressFromP2SH(MasanariWallet.getInstance().getCurrentNetworkParams()).toString())) {
                                rbf.addChangeAddr(out.getAddressFromP2SH(MasanariWallet.getInstance().getCurrentNetworkParams()).toString());
                                Log.d("SendActivity", "added change output:" + out.getAddressFromP2SH(MasanariWallet.getInstance().getCurrentNetworkParams()).toString());
                            } else {
                                ;
