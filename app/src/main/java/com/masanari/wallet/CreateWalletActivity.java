...
import com.masanari.wallet.fragments.PassphraseEntryFragment;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (create) {
                    ...
                    try {
                        HD_WalletFactory.getInstance(CreateWalletActivity.this).newWallet(12, passphrase, MasanariWallet.NB_ACCOUNTS);
                    ...
                    try {
                        HD_WalletFactory.getInstance(CreateWalletActivity.this).restoreWallet(seed, passphrase, MasanariWallet.NB_ACCOUNTS);
                    } catch (IOException ioe) {
                        ioe.printStackTrace();
