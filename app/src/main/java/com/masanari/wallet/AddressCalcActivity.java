            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    if(spType.getSelectedItemPosition() == 1)    {
                        ...
                        segwitAddress = new SegwitAddress(hd_addr.getECKey(), MasanariWallet.getInstance().getCurrentNetworkParams());
                    }
                        ...
                        segwitAddress = new SegwitAddress(receiveAddress.getReceiveECKey(), MasanariWallet.getInstance().getCurrentNetworkParams());
                    }
                    else    {
