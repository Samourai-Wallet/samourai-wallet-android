package com.masanari.wallet.payload;
...
import com.masanari.wallet.SendActivity;
...
import com.masanari.wallet.util.SIMUtil;
...
public class PayloadUtil	{
    ...
    private final static String strFilename = "masanari.dat";
    private final static String strTmpFilename = "masanari.tmp";
    private final static String strBackupFilename = "masanari.sav";

    private final static String strMultiAddrFilename = "masanari.multi";
    private final static String strUTXOFilename = "masanari.utxo";
    private final static String strFX_LBC = "masanari.fx_lbc";
    private final static String strFX_BFX = "masanari.fx_bfx";
    private final static String strFX_BTCe_USD = "masanari.fx_btce_usd";
    private final static String strFX_BTCe_RUR = "masanari.fx_btce_rur";
    private final static String strFX_BTCe_EUR = "masanari.fx_btce_eur";
    private final static String strFeesFilename = "masanari.fees";
    private final static String strPayNymFilename = "masanari.paynyms";

    private final static String strOptionalBackupDir = "/masanari";
    private final static String strOptionalFilename = "masanari.txt";
    ...
    public JSONObject getPayload() {
        try {
            ...
            wallet.put("testnet", MasanariWallet.getInstance().isTestNet() ? true : false);
...
//        Log.i("PayloadUtil", get().toJSON().toString());
        ...
        if(MasanariWallet.getInstance().hasPassphrase(context) && isExternalStorageWritable() && PrefsUtil.getInstance(context).getValue(PrefsUtil.AUTO_BACKUP, true) && HD_WalletFactory.getInstance(context).get() != null) {
...
//            Log.i("PayloadUtil", obj.toString());
            if(wallet != null) {
                ...
                if(wallet.has("testnet"))    {
                    MasanariWallet.getInstance().setCurrentNetworkParams(wallet.getBoolean("testnet") ? TestNet3Params.get() : MainNetParams.get());
                    PrefsUtil.getInstance(context).setValue(PrefsUtil.TESTNET, wallet.getBoolean("testnet"));
                }
                else    {
                    MasanariWallet.getInstance().setCurrentNetworkParams(MainNetParams.get());
