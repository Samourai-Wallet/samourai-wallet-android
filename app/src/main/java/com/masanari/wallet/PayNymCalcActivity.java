        ...
        btOK.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    ...
                    receiveSegwit = new SegwitAddress(receiveECKey, MasanariWallet.getInstance().getCurrentNetworkParams());
                    SegwitAddress sendSegwit = new SegwitAddress(sendECKey, MasanariWallet.getInstance().getCurrentNetworkParams());
                    ...
                    message += "\n";
                    message += receiveECKey.toAddress(MasanariWallet.getInstance().getCurrentNetworkParams()).toString();
                    message += "\n";
                    ...
                    message += "\n";
                    message += sendECKey.toAddress(MasanariWallet.getInstance().getCurrentNetworkParams()).toString();
                    message += "\n";
                    ...
                    AlertDialog.Builder dlg = new AlertDialog.Builder(PayNymCalcActivity.this)
                            ...
                            .setNegativeButton(R.string.display_receive_privkey, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int whichButton) {
                                    String strPrivKey = receiveECKey.getPrivateKeyAsWiF(MasanariWallet.getInstance().getCurrentNetworkParams());
