...
import com.masanari.wallet.service.BackgroundManager;
...
public class MainActivity2 extends Activity {
    ...
    public static final String ACTION_RESTART = "com.masanari.wallet.MainActivity2.RESTART_SERVICE";
    ...
    protected BackgroundManager.Listener bgListener = new BackgroundManager.Listener()  {
        ...
        public void onBecameForeground()    {
            ...
            Intent _intent = new Intent("com.masanari.wallet.MainActivity2.RESTART_SERVICE");
...
//        }
        ...
        ActionBar.OnNavigationListener navigationListener = new ActionBar.OnNavigationListener() {
            ...
            public boolean onNavigationItemSelected(int itemPosition, long itemId) {
                ...
                MasanariWallet.getInstance().setCurrentSelectedAccount(itemPosition);
                if(account_selections.length > 1)    {
                    MasanariWallet.getInstance().setShowTotalBalance(true);
                }
                else    {
                    MasanariWallet.getInstance().setShowTotalBalance(false);
                }
...
//        }
    ...
    private void doAccountSelection() {
        ...
        account_selections = new String[] {
                ...
                getString(R.string.account_Masanari),
        ...
        AlertDialog.Builder dlg = new AlertDialog.Builder(this)
                ...
                .setNegativeButton(R.string.TestNet, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        MasanariWallet.getInstance().setCurrentNetworkParams(TestNet3Params.get());
                        initDialog();
