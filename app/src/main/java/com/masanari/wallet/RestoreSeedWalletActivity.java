...
import com.masanari.wallet.fragments.ImportWalletFragment;
import com.masanari.wallet.fragments.PinEntryFragment;
...
import com.masanari.wallet.widgets.MnemonicSeedEditText;
import com.masanari.wallet.widgets.ViewPager;
...
import static com.masanari.wallet.R.id.dots;
...
public class RestoreSeedWalletActivity extends FragmentActivity implements
            ...
            case 0: {
                if (restoreMode.equals("backup")) {
                    ...
                    if (decrypted == null || decrypted.length() < 1) {
                        ...
                        RestoreWalletFromMasanariBackup(decrypted);
                    }
                } else {
     ...
     * backupData can be Mnemonic seed or Masanari Backup data
    ...
    private void RestoreWalletFromMasanariBackup(final String decrypted) {
        toggleLoading();
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                if (create) {
                    ...
                    try {
                        HD_WalletFactory.getInstance(RestoreSeedWalletActivity.this).newWallet(12, passphrase, MasanariWallet.NB_ACCOUNTS);
                    } catch (IOException ioe) {
                        ioe.printStackTrace();
                    } catch (MnemonicException.MnemonicLengthException mle) {
                        mle.printStackTrace();
                    ...
                    try {
                        HD_WalletFactory.getInstance(RestoreSeedWalletActivity.this).restoreWallet(seed, passphrase, MasanariWallet.NB_ACCOUNTS);
                    } catch (IOException ioe) {
                        ioe.printStackTrace();
                    } catch (DecoderException de) {
                        de.printStackTrace();
