...
//                Log.i("SendActivity", "amount:" + amount);
                ...
                final boolean isBIP49 = FormatsUtil.getInstance().isValidBech32(address) || Address.fromBase58(SamouraiWallet.getInstance().getCurrentNetworkParams(), address).isP2SHAddress();
