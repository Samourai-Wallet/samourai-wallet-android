...
public class Prefs {
    ...
    private final static String PREF_CIRCUIT_STATUS = "pref_enable_circ";
    ...
    public static boolean viewCircuitStatus(){
        return prefs.getBoolean(PREF_CIRCUIT_STATUS, true);
    }
    ...
    public static SharedPreferences getSharedPrefs (Context context) {
        return context.getSharedPreferences(TorPrefernceConstants.PREF_TOR_SHARED_PREFS,0 | Context.MODE_MULTI_PROCESS);
    }
}
